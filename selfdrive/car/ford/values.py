...
class CarControllerParams:
  ...
  ANGLE_RATE_LIMIT_UP = AngleRateLimit(speed_bp=[10, 25], angle_v=[0.0002, 0.0001])
  ANGLE_RATE_LIMIT_DOWN = AngleRateLimit(speed_bp=[10, 25], angle_v=[0.000225, 0.00015])
...
DBC[CAR.F_150_MK14] = dbc_dict("ford_lincoln_base_pt", RADAR.DELPHI_MRR_64)
